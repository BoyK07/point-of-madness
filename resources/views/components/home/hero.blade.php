...
<div class="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-6xl mx-auto px-6 mb-12">
        <div class="relative group">
            ...
            <div
                class="absolute -inset-8 bg-gradient-to-r from-blue-600/30 via-purple-600/40 to-blue-600/30 rounded-3xl blur-2xl opacity-50 group-hover:opacity-75 transition-all duration-1000">
            </div>
            <div
                class="absolute -inset-4 bg-gradient-to-r from-blue-500/20 via-purple-500/30 to-blue-500/20 rounded-2xl blur-xl opacity-70 group-hover:opacity-90 transition-all duration-700">
            </div>
