        ...
        <div class="text-center space-y-8">
            ...
            <div class="mb-12">
                ...
                <p class="text-gray-400 mt-4 text-sm">
                    Reviving 80s New Wave • Netherlands • Since 2023
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <a href="#" class="block text-gray-400 hover:text-purple-400 transition-colors duration-300">
                            Booking
                        </a>
                        <a href="#" class="block text-gray-400 hover:text-purple-400 transition-colors duration-300">
                            Press Kit
            ...
            <div class="border-t border-gray-700 pt-8 space-y-4">
                <div class="flex flex-col md:flex-row justify-center items-center gap-4 text-gray-400 text-sm">
                    <div>&copy; {{ Carbon::now()->year }} Point of Madness. All rights reserved.</div>
                    <div class="hidden md:block text-gray-600">•</div>
                    <div>Made with 💜 for the new wave revival</div>
                </div>
                ...
                <div class="text-center">
                    <div class="inline-flex items-center gap-2 text-xs text-gray-500">
                        ...
                        <span>Est. 2023 • Netherlands</span>
